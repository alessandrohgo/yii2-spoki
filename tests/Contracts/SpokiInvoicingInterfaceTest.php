...
{
    /**
     * Verifica che un adapter possa ricevere il contesto dell'acquisto ed emettere la
     * fattura senza che il contratto imponga alcun dettaglio sul sistema usato.
     */
